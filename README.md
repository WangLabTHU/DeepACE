...
```
[1] *Machine-guided design of cell-type-targeting cis-regulatory elements*. Nature, 2024.  

[2] *Massively parallel characterization of transcriptional regulatory elements in three diverse human cell types*. Nature, 2025.  

[3] *Modeling and designing enhancers by introducing and harnessing transcription factor binding units*.  

[4] *Saturation mutagenesis of twenty disease-associated regulatory elements at single base-pair resolution*.  

[5] *SCREEN: Search Candidate cis-Regulatory Elements by ENCODE*.  

[6] *A systematic comparison reveals substantial differences in chromosomal versus episomal encoding of enhancer activity*.  

[7] *Functional characterization of enhancer evolution in the primate lineage*.  

[8] *Interpreting cis-regulatory interactions from large-scale deep neural networks*.  

[9] *Predicting expression-altering promoter mutations with deep learning*.  

[10] *Basset: learning the regulatory code of the accessible genome with deep convolutional neural networks*. Genome Research, 2016.  

[11] *DanQ: a hybrid convolutional and recurrent deep neural network for quantifying the function of DNA sequences*. Bioinformatics, 2016.  

[12] *Sequence determinants of human gene regulatory elements*. Nature Genetics, 2022.  

[13] *Deciphering the impact of genetic variation on human polyadenylation using APARENT2*. Genome Biology, 2022.  

[14] *Predicting DNA structure using a deep learning method*. Nature Communications, 2024.  

[15] *Dissection of core promoter syntax through single nucleotide resolution modeling of transcription initiation*. bioRxiv, 2024.  

[16] *Sequence basis of transcription initiation in the human genome*. Science, 2024.  

[17] *Effective gene expression prediction from sequence by integrating long-range interactions*. Nature Methods, 2021.  

[18] *Sequential regulatory activity prediction across chromosomes with convolutional neural networks*. Genome Research, 2018.  

[19] *Deep learning sequence-based ab initio prediction of variant effects on expression and disease risk*. Nature Genetics, 2018.  

[20] *A sequence-based global map of regulatory activity for deciphering human genetics*. Nature Genetics, 2022.  

[21] *Predicting Splicing from Primary Sequence with Deep Learning*. Cell, 2019.  

[22] *Predicting RNA-seq coverage from DNA sequence as a unifying model of gene regulation*. Nature Genetics, 2025.  

[23] *Annotating the genome at single-nucleotide resolution with DNA foundation models*. Nature Methods, 2025.

[24] Qixiu Du, Han Yu, & WangLabTHU. (2026). WangLabTHU/DeepACE: (Toolkits) Anchor-based ensemble learning for assessing regulatory function of DNA sequences (v0.0.0). Zenodo. https://doi.org/10.5281/zenodo.20116129
```
