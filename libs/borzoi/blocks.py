...
def unet_conv(
    ...
    # activate
    current1 = activate(current1, activation)
    current2 = activate(current2, activation)
...
def center_average(inputs, center, **kwargs):
    current = CenterAverage(center)(inputs)
    return current


def center_slice(inputs, center, **kwargs):
    current = CenterSlice(center)(inputs)
    return current
...
def factor_inverse(inputs, components_file, **kwargs):
    current = FactorInverse(components_file)(inputs)
    return current
